...
# Lädt das Modell einmalig beim Start in den Speicher
_pipeline = joblib.load(os.getenv("MODEL_PATH"))

# Startup-Assertion: Schützt vor falschen Modellen
...
def classify_batch(images: np.ndarray) -> list[dict]:
    ...
    # Vorverarbeitung: Schwellenwert anwenden und flachdrücken
